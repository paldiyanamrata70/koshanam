      ...
      <div className="footer-container">
        ...
        <div className="md:hidden flex">
          <div className="footer-col w-1/2">
            <h4>STAY UPDATED</h4>
            <input type="tel" placeholder="Enter your mobile number" value={phoneNumber} onChange={(e) => setPhoneNumber(e.target.value)} className="subscribe-input bg-transparent border-b-2 border-black text-purple-300 px-3 py-2 mb-4 placeholder:text-[#606060] w-3/4" />
            <p className="mb-4">*Kosha does not share data with any third parties*</p>
            <button onClick={handleConnect} className="subscribe-btn mt-10 py-4 px-12 font-bold text-lg">Connect with us</button>
          </div>
          <div className="footer-col w-1/2">
            <h4>FOLLOW US</h4>
        ...
        {/* Contact Us */}
        <div className="footer-col mx-auto md:ml-16">
          <h4>CONTACT US</h4>
          <p>
          ...
          <p className="address">
            ...
            <br />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;opposite Morya Wellness Hospital,
            <br />
        ...
        {/* Desktop: Follow Us */}
        <div className="footer-col hidden md:block ml-16">
          <h4>FOLLOW US</h4>
          <div className="social-icons">
