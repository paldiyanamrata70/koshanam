      ...
      <div className="footer-container">
        ...
        <div className="md:hidden flex">
          <div className="footer-col w-1/2">
            ...
            <p className="mb-5" style={{fontSize: '10px'}}>*Kosha does not share data with any third parties*</p>
          ...
          <div className="footer-col w-1/2 ml-6">
            <h4>FOLLOW US</h4>
        ...
        {/* Contact Us */}
        <div className="footer-col text-center mx-auto md:ml-24">
          <h4>CONTACT US</h4>
